-- Complete fix for Supabase functions and RLS

-- First, clean up old functions
DROP FUNCTION IF EXISTS join_game_by_code(character varying);
DROP FUNCTION IF EXISTS join_game_by_code(varchar);
DROP FUNCTION IF EXISTS join_game(uuid);
