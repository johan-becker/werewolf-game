...
import { ActionType, NightAction, NightPhase } from '../../types/werewolf-roles.types';
    ...
    try {
      ...
      if (result.success && result.roleAssignments) {
        ...
        for (const assignment of result.roleAssignments) {
          // Find socket by broadcasting to room and letting client handle it
          // This is a simplified approach - in production you'd want proper socket mapping
          roomManager.broadcastToRoom(io, gameId, 'game:roleAssigned', {
