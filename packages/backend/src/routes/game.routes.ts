...
router.post(
  ...
  gameCreationRateLimit,
  validateCreateGame,
  gameController.createGame.bind(gameController) as any
);
...
router.post(
  ...
  gameJoinRateLimit,
  validateGameCode,
  gameController.joinByCode.bind(gameController) as any
...
router.post(
  ...
  nightActionRateLimit,
  validateGameId,
  gameController.performNightAction.bind(gameController) as any
);
router.patch(
  '/:id/phase/advance',
  validateGameId,
  gameController.advancePhase.bind(gameController) as any
);
...
router.get(
  '/:id/moon-phase',
  validateGameId,
  gameController.getMoonPhase.bind(gameController) as any
);
