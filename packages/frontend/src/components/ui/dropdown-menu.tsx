...
export const DropdownMenuTrigger: React.FC<DropdownMenuTriggerProps> = ({ children, className, ...props }) => (
  <button className={cn("dropdown-trigger", className)} {...props}>{children}</button>
)
...
export const DropdownMenuShortcut: React.FC<React.HTMLAttributes<HTMLSpanElement>> = ({ children, ...props }) => (
