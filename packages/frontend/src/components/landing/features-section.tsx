...
const features = [
  {
    ...
    description: 'Experience real-time lunar cycles that affect werewolf abilities and transformation timing.',
    color: 'text-gray-500'
  },
  {
    icon: Users,
    title: 'Pack Dynamics',
    description: 'Form alliances, establish hierarchies, and coordinate with your pack members in real-time.',
    color: 'text-green-500'
  },
  {
    icon: Shield,
    title: 'Role Strategy',
    description: 'Master unique abilities for each role - from Seer\'s insight to Alpha\'s pack leadership.',
    color: 'text-red-500'
  },
  {
    icon: Zap,
      ...
      <div className="container-werewolf">
        <div className="text-center mb-16">
          ...
          <p className="text-subheading max-w-3xl mx-auto">
            Experience the most immersive werewolf game ever created. With cutting-edge features 
            and supernatural attention to detail, every full moon brings new adventures.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="card-werewolf group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CardHeader>
