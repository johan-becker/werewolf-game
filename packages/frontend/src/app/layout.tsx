...
export const metadata: Metadata = {
  ...
  description:
    'Join the ultimate werewolf experience. Form packs, claim territories, and survive the lunar cycles.',
  ...
  return (
    <html lang="en" className={`${inter.variable} ${cinzel.variable}`} suppressHydrationWarning>
      <body className="min-h-screen bg-background font-sans antialiased">
        <ThemeProvider defaultTheme="system" enableTransformationMode>
          <WebSocketProvider>
