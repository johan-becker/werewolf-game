...
// Werewolf Components
export const PackCard = lazy(() => import('@/components/werewolf/pack-card'))
export const TerritoryMap = lazy(() => import('@/components/werewolf/territory-map'))
export const TransformationTimer = lazy(() => import('@/components/werewolf/transformation-timer'))
export const MoonPhaseIndicator = lazy(() => import('@/components/werewolf/moon-phase-indicator'))
...
export const HeroSection = lazy(() => import('@/components/landing/hero-section'))
export const FeaturesSection = lazy(() => import('@/components/landing/features-section'))
